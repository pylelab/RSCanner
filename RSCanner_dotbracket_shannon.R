...
if (length(args)<1){
  ...
  cat("\n")
  cat("    Rscript RSCanner_dotbracket_shannon.R <input_structure.dot>  <shannon.txt>\n")
  cat("\nInput:\n")
  ...
  cat("\nOutput:\n")
  cat("    bpcplot.tiff                             - output BPC line plot figure, dashed line represents the global median\n")
  cat("    smoothed_Shannonplot.tiff                - output SE line plot figure, dashed line represents the global median\n")
